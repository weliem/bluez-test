...
import weliem.BluetoothAgent;

public class BluetoothAgentManager  extends AbstractBluetoothObject {

    private final AgentManager1 rawAgentManager;
    private final BluetoothAdapter adapter;

    public BluetoothAgentManager(AgentManager1 _agentManager, BluetoothAdapter _adapter, String _dbusPath, DBusConnection _dbusConnection) {
     ...
     */
    public void registerAgent(BluetoothAgent bluetoothAgent, String _capability) throws BluezInvalidArgumentsException, BluezAlreadyExistsException {
     ...
     */
    public void unregisterAgent(BluetoothAgent bluetoothAgent) throws BluezDoesNotExistException {
     ...
     * @throws BluezDoesNotExistException when item does not exist
     */
    public void requestDefaultAgent(BluetoothAgent bluetoothAgent) throws BluezDoesNotExistException {
